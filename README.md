...
```javascript
import iterator from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-randn@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-iter-randn/tags). For example,

```javascript
import iterator from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-randn@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/random-iter-randn/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-iter-randn/actions/workflows/test.yml?query=branch:v0.2.0
...
[deno-readme]: https://github.com/stdlib-js/random-iter-randn/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-iter-randn/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-iter-randn/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-iter-randn/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-iter-randn/blob/esm/README.md
